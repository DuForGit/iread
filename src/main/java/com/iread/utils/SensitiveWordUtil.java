...
/**
 *项目名称: iread
 *类名称: SensitiveWordUtil
 *类描述: 
 *创建人: Administrator
 *创建时间: 2018年4月6日下午10:10:24
 * @version
 * @author 方秋都
 *
 */
public class SensitiveWordUtil {
	...
	static{
		initSensitiveWordMap(SensitiveWordInTxtToSet.SENSITIVE_WORD_SET);
		System.out.println("敏感词数量：" + SensitiveWordInTxtToSet.SENSITIVE_WORD_SET);
	}
